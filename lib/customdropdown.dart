    ...
    return new FadeTransition(
      ...
      child: new CustomPaint(
        painter: new _DropdownMenuPainter(
          ...
          // color: Color(0XFFEAFFFF), //Background color of dropdown
        ...
        child: new Semantics(
          ...
          child: new Material(
            ...
            // textStyle: route.style,//Need to customize here for dropdown items text
      ...
      child: new Builder(
        builder: (BuildContext context) {
          return new CustomSingleChildLayout(
            ...
            child: Padding(
              padding: const EdgeInsets.fromLTRB(15.0, 50.0, 30.0, 0.0),
              child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(9.0),border: Border.all(color: Color(0xFF11DFEB), width: 2.0),),child: Padding(
      ...
      child: new Container(
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            Expanded(
              child: Container(
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(25.0),color: Color(0XFF11DFEB),),
